...
void vector :: n_vectori()
{   int x;

cout<<"introduceti numarul de vectori:"<<endl;
cin>>x;
int z;
for (z=1;z<=x;z++)
    {vector c[z];
...
{    int poz=0;
    ...
    for (int i=1;i<dim;i++)
        ...
        {maxim=v[i];
        poz=i;}
    cout<<"valoarea maxima este "<<maxim<<" si se afla pe pozitia "<<poz;
...
void menu_output()
{
    ...
    printf("5. Elementul maxim si pozitia lui"); printf("\n");
